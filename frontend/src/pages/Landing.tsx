...
// Lenis smooth scroll is a marketing-page-only indulgence — never in the daily app
// (see .claude/rules/design.md), which is why it lives here and not at the root.
